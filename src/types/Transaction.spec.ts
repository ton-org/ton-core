...
import { base64ToUint8Array, hexStringToUint8Array, uint8ArrayToHexString } from "../utils/buffer_to_uint8array";
...
describe('Transaction', () => {
    it('should parse transaction', () => {
        ...
        const cell = Cell.fromBoc(base64ToUint8Array(boc))[0];
    ...
    it('should parse transaction and hash', () => {
        ...
        expect(uint8ArrayToHexString(tx.hash())).toEqual(uint8ArrayToHexString(cell.hash()));
